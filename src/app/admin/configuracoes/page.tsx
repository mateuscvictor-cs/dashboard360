        ...
        <div className="max-w-2xl space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <ToggleOption label="Alertas de risco crítico" defaultChecked />
              <ToggleOption label="Entregas atrasadas" defaultChecked />
              <ToggleOption label="Oportunidades de expansão" defaultChecked />
              <ToggleOption label="Insights da IA" defaultChecked />
